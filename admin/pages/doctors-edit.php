...
<body class="hold-transition sidebar-mini">
  ...
  if (isset($_POST['submit'])) {
    ...
    if (count($error) == 0 && $imageName!='') {
      $hashedpassword = $user->password_hash( $_POST['DoctorPassword'], PASSWORD_BCRYPT);
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="password" class="form-control" placeholder="Password" inputmode="password" name='DoctorPassword' >
                      </div>
                    </div>
                    <div class="form-group">
